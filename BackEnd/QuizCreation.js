var quiz = {
  ...
  addQuestion: function(question, correct, possibleAnsOne, possibleAnsTwo, possibleAnsThree) {
    this.questions.push({
      question: question,
      correct: correct,
      possibleAnsOne: possibleAnsOne,
      possibleAnsTwo: possibleAnsTwo,
      possibleAnsThree: possibleAnsThree
    });
